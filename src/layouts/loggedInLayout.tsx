  ...
  return (
    <nav className="flex flex-col gap-3 rounded-3xl border border-slate-800 bg-slate-900/90 p-4 shadow-xl shadow-slate-950/10 sm:flex-row sm:items-center sm:justify-between">
      <div className="space-y-1">
        <p className="text-sm font-semibold tracking-[0.24em] text-sky-300/80 uppercase">
          PTO Club
        </p>
        <p className="text-sm text-slate-400">
          Weekly predictions and standings
        </p>
      </div>
      <div className="flex flex-wrap items-center gap-3 text-sm text-slate-200">
        <Link
          className="rounded-2xl bg-slate-800 px-4 py-2 transition hover:bg-slate-700"
          to="/leaderboard"
        >
          Leaderboard
        </Link>
